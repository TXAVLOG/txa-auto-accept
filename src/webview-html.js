    ...
    <div class="container">
        <header>
            <div class="brand">
                ...
                <div class="brand-text">
                    <h1>${t.title}</h1>
                    <span>v7.1.0 · Liquid Glass Engine | <span style="color:var(--success);font-weight:700" id="terminal-badge">${t.terminalProtection}</span></span>
                </div>
            </div>
            <div class="nav-tabs">
        ...
        <div class="panel active" id="panel-monitor">
            ...
            <div class="engine-status">
                ...
                <span id="status-text">${t.engineStatus} v7.1.0</span>
            </div>
        ...
        <div class="panel" id="panel-about">
            <div class="about-panel">
                ...
                <div class="about-version">v7.1.0 · Liquid Glass Engine 2026</div>
